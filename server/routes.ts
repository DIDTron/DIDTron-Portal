...
export async function registerRoutes(
  ...
  // ==================== BILLING TERMS (GET routes moved to billing.routes.ts) ====================
  ...
  // ==================== INVOICES (GET routes moved to billing.routes.ts) ====================
  ...
  // ==================== PAYMENTS (GET routes moved to billing.routes.ts) ====================
  ...
  // ==================== PROMO CODES (GET routes moved to billing.routes.ts) ====================
  ...
  // ==================== REFERRALS (GET routes moved to billing.routes.ts) ====================
